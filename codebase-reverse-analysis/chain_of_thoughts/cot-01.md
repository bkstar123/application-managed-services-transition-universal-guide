...
1. **System Architecture**
   - Logical layers (Presentation, Business, Data, Infrastructure) with diagram
   - C4 system context diagram
   - Component relationships
   - Technology stack

2. **Database Deep Dive**
   - Complete ERD with ALL tables, columns, data types
   - All constraints (PK, FK, UK, CHECK, DEFAULT, NOT NULL)
   - All indexes (clustered, non-clustered, composite, fulltext)
   - All triggers with their logic
   - All stored procedures and views
   - Normalization level analysis
   - Table relationship cardinalities
...
5. **End-to-End Flows (CRITICAL)**
   - For EACH major business capability, trace:
     ...
     - All side effects (emails, events, logs)
   - Document at least: Login, Create Order, Checkout, Search, CRUD operations
...
4. Business workflows with state diagrams
...
3. How is the code organized? (conventions)
4. What are the 5 most important files to read?
5. What design patterns should I know?
...
3. Map domain events and their handlers
4. Evaluate: Is business logic in the domain layer or leaked elsewhere?
5. Identify ubiquitous language used vs. technical jargon
6. Document business invariants and rules
...
3. All business rules and where they're enforced
4. Business workflows (Mermaid state diagrams)
